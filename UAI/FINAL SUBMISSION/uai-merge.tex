...
%
%For each action-state pair, thwe compute the entropy of the corresponding Next Goal probability.
...
%%\begin{tabular}{|l|r|r|}
%%\hline
%%\bf{Action} & \bf{Context-Unaware Probability Next Goal} & \bf{Entropy} \\ \hline
%%Blocked Shot & 0.4729 & 0.9740 \\ \hline
%%Faceoff (Defensive) & 0.4743 & 0.9754 \\ \hline
%%Faceoff (Neutral) & 0.4739 & 0.9750 \\ \hline
%%Faceoff (Offensive) & 0.4712 & 0.9722 \\ \hline
%%Giveaway & 0.4752 & 0.9763 \\ \hline
%%Hit & 0.4726 & 0.9736 \\ \hline
%%Missed Shot & 0.4730 & 0.9741 \\ \hline
%%Penalty & 0.4736 & 0.9747 \\ \hline
%%Takeaway & 0.4717 & 0.9728 \\ \hline
%%\hline
%%\multicolumn{2}{|c|}{Context-Aware Average Entropy} & 0.9582 \\ \hline
%\end{tabular}
%}
%\end{center}
%\end{table}
