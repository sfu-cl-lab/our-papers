...
% to replicate Shuckers: try using the average conditional probability difference over all states where an action is taken.
...
\section{MODEL CONSTRUCTION AND REINFORCEMENT LEARNING ALGORITHMS}
...
\subsection{VALUE ITERATION DYNAMIC PROGRAMMING ALGORITHM}
