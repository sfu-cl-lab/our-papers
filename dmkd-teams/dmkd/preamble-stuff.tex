...
\usepackage{subfigure}
\usepackage{fancyhdr}
\graphicspath{{../}{figures/}{figures/3dplots}}
...
\newcommand{\reward}[3]{\it{R}_{#1}(#2,#3)}
%usage \reward{\team}{\mstate]{\action}
\newcommand{\evalue}[2]{V_{#1}(#2)}
%usage \evalue{\team}{mstate}
