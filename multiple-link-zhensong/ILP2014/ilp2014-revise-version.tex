...
\end{algorithmic}
%\label{alg:cpt}
\caption{Computing Gibbs conditional probabilities, the parameters of the Dependency Network. %\textbf{make notation consistent with ILP, not JAIR.}
