...
\begin{table}[htbp]
    ...
    \toprule
         ...
         \textcolor{blue}{\sys({$\confidence^{*}$})} & {\bf 0.68} & 0.477 & 0.269 & {\bf 0.187} & 0.107 & {\bf 0.357} & {\bf 0.681} & 0.141 & {\bf 0.531} & {\bf 0.685} & {\bf 0.707} & 0.147\\
    \bottomrule
    \end{tabular}
    }
    \vspace{-0.05in}
...
\begin{table}[htbp]
    ...
    % &\multicolumn{8}{c:}{Positive Measures} & \multicolumn{4}{c}{Negative Measures} \\\hline\hline
         ...
         \underline{-0.185} \\
         \textcolor{blue}{\sys({$\confidence^{*}$})} & {\bf 0.682} & {\bf 0.583} & {\bf 0.757} & 0.186 & {\bf 0.575} & {\bf 0.531} & 0.238 & 0.446 & \underline{-0.101} & -0.042 & \underline{-0.455} & -0.184 \\
    \bottomrule
    \end{tabular}
    }
    \vspace{-0.15in}
