/**
 * $Id: MinAggregator.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
public class MinAggregator extends UnfilteredAggregator {

    public MinAggregator(Source s) {
        super(s);
    }
    ...
    public NST createAggregateTable() {
        return source.getSourceTable().aggregate("min", "subg_id", "value");
    }
