/**
 * $Id: SearchBestFirst.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
/**
 * Performs best-first search by using an NSI as a heuristic for distance. Uses the estimated distance
 * remaining to determine which node to visit next.  Search terminates as soon as the target is reached.
 */
public class SearchBestFirst implements Search {
    private static Logger log = Logger.getLogger(SearchBestFirst.class);
    private static Random rand = new Random();
    private static final int BEST_FIRST_MAX = 1000000;
    private NSI nsi;
    private Graph graph;

    public SearchBestFirst(NSI nsi, Graph graph) {
        this.nsi = nsi;
        this.graph = graph;
    }
