/**
 * $Id: ModeEstimatorTest.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
public class ModeEstimatorTest extends TestCase {

    private static Logger log = Logger.getLogger(ModeEstimatorTest.class);
    ...
    public void testRecord() {
        ...
        assertEquals(1.0, allDistr.getCount("b"));
        ...
        assertEquals(1.0, posDistr.getCount("b"));
    ...
    public void testGetSmoothedProbs() {
        ...
        testNST.insertRow("0, a"); // ==> 0.01 + , 0.01 - (0.01 smoothed for unseen a/d, over 1 observed values)
    ...
    public void testGetSmoothedProbsWithMoreRows() {
        NST testNST = new NST("subg_id, value", "oid, str");
        testNST.insertRow("0, a"); // ==> 1.0 +, 0.01 -
        testNST.insertRow("0, a");
        testNST.insertRow("0, b");
        testNST.insertRow("0, b");
        testNST.insertRow("0, b");
        testNST.insertRow("1, d"); // ==> 1.00 -,  0.01 / 2  + (0.01 smoothed for unseed, over 1 observed value)
        ...
        assertEquals(1.0, posProbs.get("0@0"), tolerance);
        assertEquals(0.01, posProbs.get("1@0"), tolerance);
        assertEquals(0.01, negProbs.get("0@0"), tolerance);
        assertEquals(1.0, negProbs.get("1@0"), tolerance);
    }
