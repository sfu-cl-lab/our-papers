/**
 * $Id: MultinomialEstimatorTest.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
public class MultinomialEstimatorTest extends TestCase {

    private static Logger log = Logger.getLogger(MultinomialEstimatorTest.class);
    private static double tolerance = 0.000000001;
    Estimator estimator = new MultinomialEstimator();
    ...
    public void testGetSmoothedProbsWithMoreRows() {
        NST testNST = new NST("subg_id, value", "oid, str");
        testNST.insertRow("0, a"); // ==> 0.0625 + , 0.0025 - (0.01 smoothed for unseen d, over 4 observed values)
        testNST.insertRow("0, a");
        testNST.insertRow("1, d"); // ==> 1.00 -,  0.0001   + (0.01 smoothed for unseed, over 1 observed value)
        ...
        assertEquals(0.0625, posProbs.get("0@0"), tolerance);
        assertEquals(0.0025, posProbs.get("1@0"), tolerance);
        assertEquals(0.0001, negProbs.get("0@0"), tolerance);
        assertEquals(1.0, negProbs.get("1@0"), tolerance);
    }
