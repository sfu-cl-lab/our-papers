/**
 * $Id: AverageAggregatorTest.java 3658 2007-10-15 16:29:11Z schapira $
 *
 ...
 */
public class AverageAggregatorTest extends TestCase {

    static Logger log = Logger.getLogger(AverageAggregatorTest.class);
    ...
    public void testFlt() {
        ...
        AggregatorTestUtil.verifyValues(cache, new AverageAggregator(source).computeTables(cache),
                new String[]{
                        "avg([B.height])>=6",
                        "avg([B.height])>=5.5900001525878906"},
                new String[][]{
