/**
 * $Id: MaxAggregatorTest.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
public class MaxAggregatorTest extends TestCase {
    ...
    static Logger log = Logger.getLogger(MaxAggregatorTest.class);
    ...
    public void testFlt() {
        ...
        AggregatorTestUtil.verifyValues(cache, new MaxAggregator(source).computeTables(cache),
                new String[]{
                        "max([B.height])>=6.5",
                        "max([B.height])>=6.09000015"},//TODO: figure out precision issue
                new String[][]{
