/**
 * $Id: GiniTest.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
public class GiniTest extends TestCase {

    private static final Logger log = Logger.getLogger(GiniTest.class);
    ...
    protected void setUp() throws Exception {
        ...
        rptState.featureSettingList = FSGenerationUtil.createFSTables(container,
                new Source[]{genderSource, ageSource}, rptState);
    ...
    public void testTrueClassLabel() {
        ...
        RPTScoringModule giniScore = new GiniScore().compute(rptState, labelSource.getSourceTable(), rptState.subgIDs, fsNST, null);
        ...
        assertEquals(0.4444, ((GiniScore) giniScore).measure, 0.0001);
    }
