/**
 * $Id: InMemoryGraphTest.java 3658 2007-10-15 16:29:11Z schapira $
 *
...
public class InMemoryGraphTest extends TestCase {
    ...
    public void testDirected() {
        InMemoryGraph inMemoryGraph = new InMemoryGraph(true);
        Set<Node> neighbors = inMemoryGraph.getNeighbors(4);
    ...
    public void testUnDirectedMultiple() {
        InMemoryGraph inMemoryGraph = new InMemoryGraph(false);
        Set<Node> neighbors = inMemoryGraph.getNeighbors(ConversionUtils.stringToIntegerList("4,5"));
