...
%\usepackage{floatflt}
%\usepackage[normalleading,normalmargins,normalsections,normalindent,normaltitle,normallooseness]{savetrees}
...
\newcommand{\statistic}{U}
\newcommand{\mean}{m}
\newcommand{\lscore}{\it{local}_{\score}}
\newcommand{\score}{S}
...
\newcommand{\parents}{\mathbf{pa}}
\newcommand{\Parents}{\mathbf{PA}}
\newcommand{\pstate}{\pi} % state of a parent for a relationship variable
...
%logic notation
\newcommand{\functor}{f}
\newcommand{\functors}{\set{f}}
\newcommand{\variable}{X} % first-order variable
\newcommand{\numvariables}{\#_{V}}
\newcommand{\varbound}{\it{maxVar}}
...
\newcommand{\ftable}{\it{FT}} % frequency table
\newcommand{\jtables}{m}
...
%% systems
\newcommand{\apriori}{\textsc{Apriori }}
\newcommand{\warmr}{\textsc{Warmr }}
\newcommand{\test}{test}
\def\set#1{\mathbf{#1}}
